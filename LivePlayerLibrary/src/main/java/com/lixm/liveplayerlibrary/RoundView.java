...
public class RoundView extends ImageView {
    ...
    public RoundView(Context context, AttributeSet attrs) {
        ...
        mBorderRadius = a.getDimensionPixelSize(
                R.styleable.RoundImageView_borderRadiusDimension, (int) TypedValue
                        .applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                                BODER_RADIUS_DEFAULT, getResources()
                                        .getDisplayMetrics()));// 默认为10dp
        type = a.getInt(R.styleable.RoundImageView_iamgeType, TYPE_ROUND);// 默认为Circle
    ...
    private Bitmap drawableToBitamp(Drawable drawable) {
        ...
        try {
            ...
            System.gc();
            return BitmapFactory.decodeResource(getResources(), R.mipmap.head);
        }
    }
