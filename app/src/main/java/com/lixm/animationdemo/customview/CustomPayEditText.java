 ...
 * @detail  自定义支付密码框
 */
public class CustomPayEditText extends RelativeLayout {
    ...
    public CustomPayEditText(Context context) {
        this(context, null);
    }

    public CustomPayEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomPayEditText(Context context, AttributeSet attrs, int defStyleAttr) {
